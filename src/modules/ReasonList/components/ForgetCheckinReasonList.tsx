...
export default function ForgetCheckoutReasonList(props: IProps) {
    ...
    const getLeaveReasonListAsync = async (page: any) => {
        const data = await getLeaveReasonList({ pageIndex: page, size: 10, reason_type_code: 'FORGOT_CHECK_IN_OUT_REASON'});
        setTotal(data.total)
