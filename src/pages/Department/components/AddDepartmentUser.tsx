...
const AddDepartmentUser = (props: IProps) => {
...
let DepartmentUser = Form.create()(AddDepartmentUser);
export default connect(mapStateToProps, mapDispatchToProps)(DepartmentUser);
